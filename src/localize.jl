...
function localize(SENSE_LIDAR::Channel, SENSE_GPS::Channel, LOCALIZE::Channel, EGO_CMD::Channel, EMG::Channel, lidar, road, buildings)
    ...
    while true
        ...
        # return - 
        # should we store the particles for the next iteration? 
        # what do we do with this? 
        update_particles!(particles, dists, deltat, buildings, ego_meas, lidar.max_beam_length)
       
        
        # what do I do for the things I don't want to replace
        # are we only replacing the new position? 
        # is this speed and heading same as gps which means speed and heading was already exposed to us? 
        # all these can be 0
        ...
        # capture system time
        # time_elapsed = 
        # subtract from time at the start and assign this to sth...
